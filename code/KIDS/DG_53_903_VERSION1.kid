...
DGMHVAC^^0^B147840619
"BLD",9823,"KRN",9.8,"NM",4,0)
DGMHVUTL^^0^B130160424
...
^390.12^3^3^3150126^^
"DATA",390.01,1,2,1,0)
We are strongly encouraging patients to enroll online for a My HealtheVet
"DATA",390.01,1,2,2,0)
account. With it you can refill VA prescriptions, view lab results and
"DATA",390.01,1,2,3,0)
medical records, and securely email your health care team.
"DATA",390.01,1,3)
Yes - I am already enrolled.
"DATA",390.01,2,0)
...
"DATA",390.01,3,2,5,0)
I will give you some easy-to-follow instructions to take home and 
"DATA",390.01,3,2,6,0)
enroll or I can schedule a time for you to enroll with a My HealtheVet
"DATA",390.01,3,2,7,0)
assistant. Once registered you will need to return to a VA clinic and sign
"DATA",390.01,3,2,8,0)
a release of information form. Photo ID required. (Instructions for 
"DATA",390.01,3,2,9,0)
optional online Authentication process are also available)
"DATA",390.01,3,3)
Yes - But I do not want to enroll right now.
"DATA",390.01,3,4)
D ACTIONS^DGMHV(.DGMSACT,.ACTSEL,,"S")
...
"DATA",390.01,4,2,7,0)
Once registered you will need to return to a VA clinic and sign a release 
"DATA",390.01,4,2,8,0)
of information form. Photo ID required. (Instructions for optional 
"DATA",390.01,4,2,9,0)
online Authentication process are also available)
"DATA",390.01,4,3)
...
4
"DATA",390.02,13,1,5,0)
2
"DATA",390.02,13,1,6,0)
1
...
"RTN","DGMHVAC",10,0)
 N DGMHVOUT,DGMHVQ,DGMHVI,DGRSPNS S DGMHVQ=0
"RTN","DGMHVAC",11,0)
...
"RTN","DGMHVAC",17,0)
 ;
"RTN","DGMHVAC",18,0)
MAIN(DFN,DGABB) ; Main Driver for Enrollment 'screen'. 
"RTN","DGMHVAC",19,0)
 ; Prompt for three MHV Enrollment fields - include previously entered values as defaults
"RTN","DGMHVAC",20,0)
...
"RTN","DGMHVAC",23,0)
 N DGRPFLD,DGMHV,DGMHAC,DGMHSEL,DGMHVNOW,DGRSNPT,DGRSNTXT,X,Y
"RTN","DGMHVAC",24,0)
 S DGMHAC="",DGMHSEL="",DGMHVNOW=$$NOW^XLFDT
"RTN","DGMHVAC",25,0)
 I '$G(DGABB) D CLEAR^DGMHV W !!!
"RTN","DGMHVAC",26,0)
 ; Don't ask enrollment question if 'abbreviated' mode and already populated with YES
"RTN","DGMHVAC",27,0)
 K DIRUT W !
"RTN","DGMHVAC",28,0)
 S DGMHVQ=0
...
"RTN","DGMHVAC",67,0)
 S DIR("B")=AUDFLT
"RTN","DGMHVAC",68,0)
 S DIR("A",1)="Select (Y) YES if patient already has an Authenticated MHV account."
"RTN","DGMHVAC",69,0)
 S DIR("A",2)="Select (A) ACTION if patient would like to upgrade to Authenticated MHV account."
"RTN","DGMHVAC",70,0)
 S DIR("A",3)="Select (N) NO if patient refuses an Authenticated MHV account."
"RTN","DGMHVAC",71,0)
 S DIR("A",4)=""
"RTN","DGMHVAC",72,0)
...
"RTN","DGMHVAC",77,0)
 I MHV("AUTH")=1 S DGTXT="- Patient already has an authenticated account."
"RTN","DGMHVAC",78,0)
 I MHV("AUTH")=0 S DGTXT="- Patient refuses an upgraded MHV account."
"RTN","DGMHVAC",79,0)
 I MHV("AUTH")=2 S DGTXT="- Patient would like to upgrade to an authenticated MHV account."
"RTN","DGMHVAC",80,0)
...
"RTN","DGMHVAC",104,0)
 ;
"RTN","DGMHVAC",105,0)
ENROLL  ; MHV Enrollment
"RTN","DGMHVAC",106,0)
 D CLEAR^DGMHV
"RTN","DGMHVAC",107,0)
 W !,"Step 1 of 3: My HealtheVet Enrollment",!,"--------------------------------------",!
"RTN","DGMHVAC",108,0)
...
"RTN","DGMHVAC",112,0)
 .N DGADFLT,UTILITY,DIC,DA,DR S DIQ(0)="I",DIC=2,DA=DFN,DR="537036" D GETS^DIQ(DIC,DFN,DR,"I","UTILITY")
"RTN","DGMHVAC",113,0)
 .S DGADFLT=$G(UTILITY(2,DFN_",",537036,"I"))
"RTN","DGMHVAC",114,0)
 .D GETRSN("patient is not enrolled",.DGRSNPT,.DGRSNTXT,DGADFLT,2.1) Q:$G(DGMHVOUT)!$G(DGMHVQ)
"RTN","DGMHVAC",115,0)
...
"RTN","DGMHVAC",122,0)
 .Q:$G(DGABB)&$G(^DPT(DFN,2))  ; Quit if 'abbreviated' mode and this was answered previously
"RTN","DGMHVAC",123,0)
 .N DGOLDEN S DGOLDEN=$P($G(^DPT(DFN,2)),"^")
"RTN","DGMHVAC",124,0)
 .N DIE,DA S DIE="^DPT(",DA=DFN,DR="537027////1;537030////"_DGMHVNOW D ^DIE
"RTN","DGMHVAC",125,0)
 .; If "Enrolled:" changed from NO to YES, remove NO values in AUTHENTICATED and SECURE MESSAGING
"RTN","DGMHVAC",126,0)
...
"RTN","DGMHVAC",128,0)
 .N MHVND S MHVND=$G(^DPT(+DFN,2))
"RTN","DGMHVAC",129,0)
 .I $P(MHVND,"^",2)=0 F DGFLD=537028,537034,537037 D FILRNA(DFN,DGFLD,"@")
"RTN","DGMHVAC",130,0)
 .I $P(MHVND,"^",3)=0 F DGFLD=537029,537035,537039 D FILRNA(DFN,DGFLD,"@")
"RTN","DGMHVAC",131,0)
 Q
"RTN","DGMHVAC",132,0)
 ;
...
"RTN","DGMHVAC",140,0)
 .N DGADFLT,UTILITY,DIC,DA,DR S DIQ(0)="I",DIC=2,DA=DFN,DR="537037" D GETS^DIQ(DIC,DFN,DR,"I","UTILITY")
"RTN","DGMHVAC",141,0)
...
"RTN","DGMHVAC",147,0)
 .N DIE,DR,DA S DIE="^DPT(",DR="537028////"_DGMHV("AUTH")_";537031////"_DGMHVNOW,DA=DFN D ^DIE
"RTN","DGMHVAC",148,0)
...
"RTN","DGMHVAC",153,0)
 .N DGFLD,MHVND S MHVND=$G(^DPT(+DFN,2))
"RTN","DGMHVAC",154,0)
 .I $P(MHVND,"^",2)=0 F DGFLD=537034,537037 D FILRNA(DFN,DGFLD,"@")
"RTN","DGMHVAC",155,0)
 .I $P(MHVND,"^",3)=0 F DGFLD=537029,537035,537039 D FILRNA(DFN,DGFLD,"@")
"RTN","DGMHVAC",156,0)
...
"RTN","DGMHVAC",157,0)
 .N DGOLDAU S DGOLDAU=$P($G(^DPT(DFN,2)),"^",2)
"RTN","DGMHVAC",158,0)
 .W !! N DGDPTSOC S DGDPTSOC=+$O(^DPT(DFN,1,"A"),-1)+1 D ACTIONS^DGMHV(.DGMHAC,.DGMHSEL,DGDPTSOC,"A")
"RTN","DGMHVAC",159,0)
 .N DGCURSEL S DGCURSEL=$O(DGMHSEL(0)) I 'DGCURSEL D  Q
"RTN","DGMHVAC",160,0)
 ..;N DIE,DA S DIE="^DPT(",DA=DFN,DR="537028////@;537031////"_DGMHVNOW D ^DIE
"RTN","DGMHVAC",161,0)
...
"RTN","DGMHVAC",166,0)
 .I $P(MHVND,"^",2)=0 F DGFLD=537034,537037 D FILRNA(DFN,DGFLD,"@")
"RTN","DGMHVAC",167,0)
 .F DGFLD=537029,537035,537039 D FILRNA(DFN,DGFLD,"@")
"RTN","DGMHVAC",168,0)
 W !
"RTN","DGMHVAC",169,0)
 Q
...
"RTN","DGMHVAC",177,0)
 .N DGMDFLT,UTILITY,DIC,DA,DR S DIQ(0)="I",DIC=2,DA=DFN,DR="537038" D GETS^DIQ(DIC,DFN,DR,"I","UTILITY")
"RTN","DGMHVAC",178,0)
...
"RTN","DGMHVAC",183,0)
 .N DIE,DR,DA S DIE="^DPT(",DR="537029////"_DGMHV("OPTINQ")_";537032////"_DGMHVNOW,DA=DFN D ^DIE
"RTN","DGMHVAC",184,0)
 .D FILRNA(DFN,537038,DGRSNPT)
"RTN","DGMHVAC",185,0)
 .I $P($G(^DGMHV(390.03,DGRSNPT,0)),"^")="Other" D FILRNA(DFN,537035,DGRSNTXT)
"RTN","DGMHVAC",186,0)
 I $G(DGMHV("OPTINQ"))=1 N DIE,DA S DIE="^DPT(",DA=DFN,DR="537029////1;537032////"_DGMHVNOW D ^DIE
"RTN","DGMHVAC",187,0)
 I $G(DGMHV("OPTINQ"))=2 D  Q
"RTN","DGMHVAC",188,0)
 .N DGOLDMSG S DGOLDMSG=$$GETMSG^DGMHVUTL(DFN)
"RTN","DGMHVAC",189,0)
 .W !! N DGDPTSOC S DGDPTSOC=+$O(^DPT(DFN,1,"A"),-1)+1 D ACTIONS^DGMHV(.DGMHAC,.DGMHSEL,DGDPTSOC,"M")
"RTN","DGMHVAC",190,0)
 .N DGCURSEL S DGCURSEL=$O(DGMHSEL(0)) I 'DGCURSEL D  Q
"RTN","DGMHVAC",191,0)
...
"RTN","DGMHVAC",205,0)
 .N UTILITY,DIC,DA,DR S DIQ(0)="I",DIC=2,DA=DFN,DR="537038" D GETS^DIQ(DIC,DFN,DR,"I","UTILITY")
"RTN","DGMHVAC",206,0)
 .S DGMDFLT=$G(UTILITY(2,DFN_",",537038,"I"))
"RTN","DGMHVAC",207,0)
 Q:'$G(REASPT)
...
"RTN","DGMHVAC",209,0)
 .N DIR,X,Y S DIR("B")=$G(DGDFTXT),DIR(0)="FAO^2:250",DIR("A")="Other Reason Text (250 Chars Max): " D ^DIR
"RTN","DGMHVAC",210,0)
...
"RTN","DGMHVAC",226,0)
 .N DA,DINUM,X,DIC S DIC(0)="LEZ",DIC="^DPT(DFN,DGNODE,",DA(2)=DFN,DA(1)=NEXT,DINUM=DA(1),X=NEXT D FILE^DICN
"RTN","DGMHVAC",227,0)
 .N DIE,DA,DIR S DIE="^DPT("_DFN_","_DGNODE_",",DA(1)=DFN,DA=DGCNT,DR=.01_"////"_DGACTSEL(NEXT,"IEN") D ^DIE
"RTN","DGMHVAC",228,0)
 Q
"RTN","DGMHVAC",229,0)
 ;
...
"RTN","DGMHVAC",260,0)
 ;
"RTN","DGMHVAC",261,0)
 N DGIQ,MHVOK,MHVOKND,MHVEN,MHVBAD,UTILITY
"RTN","DGMHVAC",262,0)
 N DIC,DA,DR S DIQ(0)="I",DIC=2,DA=DFN,DR="537027:537032" D GETS^DIQ(DIC,DFN,DR,"I","UTILITY")
"RTN","DGMHVAC",263,0)
...
"RTN","DGMHVAC",291,0)
 I $G(DGLST1) S DGL1TXT=$G(DGLST5(DGLST1,1,"TXT",1))
"RTN","DGMHVAC",292,0)
 I $E($G(ACTXT),1,$L($G(ACTXT)))=$E($G(DGL1TXT),1,$L($G(ACTXT))) S DGMATCH=1
"RTN","DGMHVAC",293,0)
 Q $S($G(DGMATCH):1,1:0)
"RTN","DGMHVUTL")
0^4^B130160424
...
"RTN","DGMHVUTL",21,0)
 .I $G(DGMHVOUT)="E" N DIE,DA S DIE="^DPT(",DA=DFN,DR="537027////1;537030////"_$$NOW^XLFDT D ^DIE
"RTN","DGMHVUTL",22,0)
 .H .5
"RTN","DGMHVUTL",23,0)
 Q
...
"RTN","DGMHVUTL",26,0)
 ; This is the MHV enrollment pseudo-screen display; allow entry of 1 to edit the fields as a group, in sequence.
"RTN","DGMHVUTL",27,0)
...
"RTN","DGMHVUTL",34,0)
 W !!!,"[1]         Enrolled: ",$S(MHVEN=0:"NO",MHVEN=1:"YES",1:"UNANSWERED") I MHVEN=1!(MHVEN=0) D
"RTN","DGMHVUTL",35,0)
...
"RTN","DGMHVUTL",37,0)
 .N DGRSNTXT S DGRSNTXT=$$LKUPRTXT^DGMHVAC(DFN,2.1) I (REASONE="Other")&($L(DGRSNTXT)>2) S REASONE=REASONE_" - "_DGRSNTXT
"RTN","DGMHVUTL",38,0)
...
"RTN","DGMHVUTL",47,0)
 .N DGRSNTXT S DGRSNTXT=$$LKUPRTXT^DGMHVAC(DFN,2.2) I (REASONE="Other")&($L(DGRSNTXT)>2) S REASONE=REASONE_" - "_DGRSNTXT
"RTN","DGMHVUTL",48,0)
 .N MARX,I,LINE D TXT^DGMHV(REASONE,58) F I=1:1:$O(MARX(""),-1) S LINE=$G(MARX(I)) D
"RTN","DGMHVUTL",49,0)
 ..I I=1 W LINE S DGRSNCNT=1 Q
...
"RTN","DGMHVUTL",63,0)
 .N DGRSNTXT S DGRSNTXT=$$LKUPRTXT^DGMHVAC(DFN,2.3) I REASONE="Other"&($L(DGRSNTXT)>2) S REASONE=REASONE_" - "_DGRSNTXT
"RTN","DGMHVUTL",64,0)
...
"RTN","DGMHVUTL",78,0)
 .N DIR S DIR("A")="Select an Enrollment step, or RETURN to continue: "
"RTN","DGMHVUTL",79,0)
 .S DIR(0)="SAO^1:Enrollment;2:Authentication;3:Secure Messaging"
"RTN","DGMHVUTL",80,0)
...
"RTN","DGMHVUTL",83,0)
 S DGMHVOUT=$S(DGSCHTR[(","_DGRSPNS_",")=1:0,1:1)
"RTN","DGMHVUTL",84,0)
 Q DGRSPNS
"RTN","DGMHVUTL",85,0)
 ;
"RTN","DGMHVUTL",86,0)
ENQACHK(DFN)  ; Return followup question in DGSUPTXT if last action taken for patient DFN was one of the 4 enrollment actions
"RTN","DGMHVUTL",87,0)
 N DGSUP1,DGSUP2,DGSUP3,DGACT1,DGACT2,DGACT3,DGACT4
"RTN","DGMHVUTL",88,0)
 S DGMHVOUT=$G(DGMHVOUT)
"RTN","DGMHVUTL",89,0)
 S DGACT1="Helped patient to create"
"RTN","DGMHVUTL",90,0)
 S DGACT2="Scheduled future appointment for patient to enroll"
"RTN","DGMHVUTL",91,0)
 S DGACT3="Referred patient to the MHV office"
"RTN","DGMHVUTL",92,0)
 S DGACT4="Gave patient MHV enrollment instructions"
"RTN","DGMHVUTL",93,0)
 S DGSUP1="Were you successful in creating your My HealtheVet account?"
"RTN","DGMHVUTL",94,0)
 S DGSUP2=$P(DGSUP1,"?")_" during your last visit?"
"RTN","DGMHVUTL",95,0)
 S DGSUP3="Were you able to create a My HealtheVet account from the enrollment instructions we gave you last time?"
"RTN","DGMHVUTL",96,0)
 S DGSUPTXT=$S($$LASTACHK^DGMHVAC(DFN,DGACT1)!$$LASTACHK^DGMHVAC(DFN,DGACT2):DGSUP2,$$LASTACHK^DGMHVAC(DFN,DGACT3):DGSUP1,$$LASTACHK^DGMHVAC(DFN,DGACT4):DGSUP3,1:"")
"RTN","DGMHVUTL",97,0)
 Q DGSUPTXT
"RTN","DGMHVUTL",98,0)
 ;
...
"RTN","DGMHVUTL",129,0)
 D CLEAR^DGMHV
"RTN","DGMHVUTL",130,0)
 W !!?20,"MY HEALTHEVET ENROLLMENT STATUS"
"RTN","DGMHVUTL",131,0)
...
"RTN","DGMHVUTL",136,0)
 ;
"RTN","DGMHVUTL",137,0)
SELFLDS(DFN) ; Get selectable enrollment fields based on values of other fields
"RTN","DGMHVUTL",138,0)
 ;
"RTN","DGMHVUTL",139,0)
...
"RTN","DGMHVUTL",166,0)
 ;
"RTN","DGMHVUTL",167,0)
GETEN(DFN) ; Get value of MHV Enrolled
"RTN","DGMHVUTL",168,0)
 ;
"RTN","DGMHVUTL",169,0)
 N MHVEN,MHVAU,MHVMSG,MHVFLDS,DGFLDSEL
...
"RTN","DGMHVUTL",205,0)
 ;
"RTN","DGMHVUTL",206,0)
UP ;"Upgrade to an Authenticated My HealtheVet account to view parts of your VA health record. This requires one-time in-person identity verification (show photo ID). Read and sign this Release of Information form (10-5345a-MHV).
"RTN","DGMHVUTL",207,0)
 ; Photo ID required. (Instructions for optional online Authentication process are also available)"
"RTN","DGMHVUTL",208,0)
 Q
"RTN","DGMHVUTL",209,0)
SMSG ;"With Secure Messaging, Veterans can communicate online with VA health care teams about health questions, to request prescription renewals, or schedule appointments."
"RTN","DGMHVUTL",210,0)
 Q
"RTN","DGMHVUTL",211,0)
AUTH ;"With an Authenticated MHV account patients can view VA appointments, lab results and VA medical records online."
"RTN","DGMHVUTL",212,0)
 Q
"RTN","DGMHVUTL",213,0)
MHVPCHK(DFN) ; Consistency checker MHV update
"RTN","DGMHVUTL",214,0)
 ; Don't trigger update if MHV ENROLLED has not been answered, and enrollment socialization action is pending
"RTN","DGMHVUTL",215,0)
 N DGMHVOUT,DGMHVQ,DP,DG,DK,DH,DM,DQ,DR,DL,X,Y,DC,DE,DIC,DIE,DIIENS,DIFLD,DIETMP,DW,D,D0,DG,DI,DIEL,DU,DV
"RTN","DGMHVUTL",216,0)
 ;N (DUZ,DFN,U,DT)
"RTN","DGMHVUTL",217,0)
...
"RTN","DGMHVUTL",223,0)
 ;
"RTN","DGMHVUTL",224,0)
GETFLDS(DFN,FLDARRAY) ; Get mhv enrollment status field and date values, place in array formatted for merging with historical action display
"RTN","DGMHVUTL",225,0)
...
"RTN","DGMHVUTL",229,0)
 .S FLDARRAY(DGENDT,1,"TXT",1)="MHV Enrollment "_$S(DGEN=1:"confirmed.",1:"")
"RTN","DGMHVUTL",230,0)
 I DGAUDT&($G(DGAUTH)=1) S FLDARRAY(DGAUDT,1)="",FLDARRAY(DGAUDT,1,"TXT")=1 D
"RTN","DGMHVUTL",231,0)
 .S FLDARRAY(DGAUDT,1,"TXT",1)="MHV Authenticated Upgrade "_$S(DGAUTH=1:"confirmed.",1:"")
"RTN","DGMHVUTL",232,0)
 I DGMSGDT&($G(DGMSG)=1) S FLDARRAY(DGMSGDT,1)="",FLDARRAY(DGMSGDT,1,"TXT")=1 D
"RTN","DGMHVUTL",233,0)
 .S FLDARRAY(DGMSGDT,1,"TXT",1)="MHV Secure Messaging  "_$S(DGMSG=1:"confirmed.",1:"")
"RTN","DGMHVUTL",234,0)
 Q
"RTN","DGMHVUTL",235,0)
...
"RTN","DGMHVUTL",243,0)
 I $G(DGFLDNO(1))!$G(DGFLDNO(2))!$G(DGFLDNO(3)) W !?10,"MHV Enrollment Progress" ;,?40,"Status" D
"RTN","DGMHVUTL",244,0)
 W !,DGDASH
"RTN","DGMHVUTL",245,0)
 I $G(DGFLDNO(1)) W !,$$ENDATE(DFN),?10,"[Step 1 of 3]  My HealtheVet Enrollment: ",?56,$S(DGEN=1:"COMPLETED",DGEN=2:"ACTION PENDING",DGEN=0:"REFUSED",1:"UNANSWERED")
"RTN","DGMHVUTL",246,0)
...
"RTN","DGMHVUTL",249,0)
 Q
"RTN","DGMHVUTL",250,0)
ENDATE(DFN,INTERNAL) ; Most recent date mhv enrollment was updated
"RTN","DGMHVUTL",251,0)
...
"RTN","DGMHVUTL",261,0)
 S DGAUTHDT=$G(MHVFLD(2,DFN_",",537031,"I")) I DGAUTHDT S DGAUTHDT=$$FMTE^XLFDT(DGAUTHDT,2)
"RTN","DGMHVUTL",262,0)
...
"RTN","DGMHVUTL",268,0)
 S DGMSGDT=$G(MHVFLD(2,DFN_",",537032,"I")) I DGMSGDT S DGMSGDT=$$FMTE^XLFDT(DGMSGDT,2)
"RTN","DGMHVUTL",269,0)
...
"RTN","DGRPC3",205,0)
 Q:'$G(DFN)!'$G(DGPRFLG)
"RTN","DGRPC3",206,0)
 N DGFLDCHK,DGMHVACT,DGMHVOUT,DGMHVQ,X,Y
"RTN","DGRPC3",207,0)
 Q:$$MHVOK^DGMHVAC(DFN) 
"RTN","DGRPC3",208,0)
 ;S DGFLDCHK=$$GETEN^DGMHVUTL(DFN)
"RTN","DGRPC3",209,0)
 ;I DGFLDCHK'="" S DGFLDCHK=$$GETAUTH^DGMHVUTL(DFN)
"RTN","DGRPC3",210,0)
 ;I DGFLDCHK'="" S DGFLDCHK=$$GETMSG^DGMHVUTL(DFN)
"RTN","DGRPC3",211,0)
 ;Q:DGFLDCHK'=""
"RTN","DGRPC3",212,0)
 ; Quit if MHV ENROLLED has not been answered, and enrollment action is pending
"RTN","DGRPC3",213,0)
 S DGMHVACT=$$ENQACHK^DGMHVUTL(DFN) Q:(DGMHVACT]"")&'$G(^DPT(DFN,2))
"RTN","DGRPC3",214,0)
 S DGMHVACT=$$ENTRYFLD^DGMHVUTL(DFN)
"RTN","DGRPC3",215,0)
 ;D MAIN^DGMHVAC(DFN,DGMHVACT,1)
"RTN","DGRPC3",216,0)
 S:'$$MHVOK^DGMHVAC(DFN) FILERR(315)=""
"RTN","DGRPC3",217,0)
 ;S FILERR(315)=""
